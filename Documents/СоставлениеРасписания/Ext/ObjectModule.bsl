...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Для Каждого ТекСтрокаРасписание Из Расписание Цикл
		...
		// Если есть - продолжить оглавление тем
		...
		// Проверка на удачность генерации журналов
...
Функция ГенерацияЖурналов(ТекСтрокаРасписание, СтрокаРабочейПрограммы)
	...
	НовыйДокумент.ДатаЗанятия = ДатаРасписания;
	НовыйДокумент.Занятие = ТекСтрокаРасписание.Занятие;
	...
	НовыйДокумент.Содержание = СтрокаРабочейПрограммы.Содержание;
	...
	НовыйДокумент.ФормаОрганизации = СтрокаРабочейПрограммы.ФормаОрганизации;
...
Процедура ОбработкаУдаленияПроведения(Отказ)
	...
	|	ПроведениеЗанятия.Основание КАК Основание
	|ИЗ
	|	Документ.ПроведениеЗанятия КАК ПроведениеЗанятия
	|ГДЕ
	|	ПроведениеЗанятия.Основание = &Ссылка");
