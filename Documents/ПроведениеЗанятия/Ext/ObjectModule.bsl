Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	// если занятие является промежуточной аттестацией, записывается регистр ИтоговыеОценки
	Если ФормаОрганизации = Перечисления.ФормаОрганизацииОбучения.ПромежуточнаяАттестация Тогда
		...
		Для Каждого ТекСтрокаИтогиПроведения Из ИтогиПроведения Цикл
			...
			Движение.Дисциплина = Дисциплина;
			Движение.Обучающийся = ТекСтрокаИтогиПроведения.Обучающийся;
			Движение.Оценка = ТекСтрокаИтогиПроведения.Отметка;
			Движение.ПромежуточнаяАттестация = ФормаОрганизации; //не воспринимает форму организации П/А - ИСПРАВИТЬ!!!
		КонецЦикла;
	КонецЕсли;
КонецПроцедуры
